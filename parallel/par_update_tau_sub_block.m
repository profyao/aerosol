function [new_tau,new_resid] = par_update_tau_sub_block(sub_block_start,sub_block_end,num_pixel,x,y,old_resid,theta,kappa,sigmasq,delta,Method,ExtCroSect,CompSSA,i,j,old_tau,reg,smart,kf,add_limit,const)
    ...
    for p =  sub_block_start : min(sub_block_end,num_pixel)
        ...
        [old_residp,old_taup,thetap,old_tau_neighbor,regp,smartp] = par_preprocess_tau(x,y,p,old_resid,theta,old_tau,i,j,reg,smart,kf,add_limit,const);
